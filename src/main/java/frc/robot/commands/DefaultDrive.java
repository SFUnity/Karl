...
public class DefaultDrive extends CommandBase {
  ...
  @Override
  public void execute() {
    m_drive.tankDrive((m_left.getAsDouble() + m_forward.getAsDouble() + m_backward.getAsDouble() / 3.0), 
                      (m_right.getAsDouble() + m_forward.getAsDouble() + m_backward.getAsDouble() / 3.0));
  }
